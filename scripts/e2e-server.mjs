...
// fresh file, migrations applied, seeded, then `next dev` on port 3100 in demo mode with a
// fixed clock start (a Tuesday, so "tomorrow" in demo step 10 is a working day).
...
const child = spawn("npx", ["next", "dev", "-p", "3100"], { stdio: "inherit", env, shell: true });
